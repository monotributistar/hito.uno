...
export const PROPIEDADES: Propiedad[] = [
  {
    ...
    /* PLACEHOLDER: descripcion escrita a partir de las fotos, no de datos del
       dueño. Al mirarlas aparecieron dos espacios distintos (el departamento y
       una planta baja con varias camas) y falta confirmar si son la misma
       propiedad. Ver PROPIEDADES/Valeria 1/CATALOGO.md. */
    descripcion:
      'Departamento de playa en Valeria del Mar, con cocina integrada, estar con sofá cama y ventanal al balcón. Abajo, un espacio con varias camas para cuando viene más gente.',
    ...
    fotos: [
      ...
      {
        src: '/images/propiedades/valeria-1/pb_camas_02.webp',
        alt: 'Planta baja: dos camas contra el revestimiento de junco, con mesitas de pino',
      },
      {
        src: '/images/propiedades/valeria-1/pb_camas_03.webp',
        alt: 'Planta baja: dos camas y un placar de pino abierto',
      },
      {
        src: '/images/propiedades/valeria-1/pb_cama-escalera_01.webp',
        alt: 'Planta baja: cama matrimonial junto a la escalera que baja del departamento',
      },
      {
        src: '/images/propiedades/valeria-1/pb_estar_01.webp',
        alt: 'Planta baja: mesa con dos sillas, espejo de pie y perchero',
      },
    ],
    whatsapp: {
      telefono: TELEFONO,
